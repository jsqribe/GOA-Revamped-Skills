		...
		tobirama_summon
			...
			Use(mob/user)
				...
				spawn()
					...
					o.clan = "Capacity"
					//Skills
					o.skillsx=list(KAWARIMI,SHUNSHIN,WINDMILL_SHURIKEN,SUITON_VORTEX,SUITON_SHOCKWAVE,SUITON_GUNSHOT,DOTON_CHAMBER,DOTON_CHAMBER_CRUSH,DOTON_EARTH_FLOW,SUITON_DRAGON,SUITON_SHARK_GUN,SUITON_SHARK,SUITON_COLLISION_DESTRUCTION,SUITON_PRISON,DOTON_EARTH_SHAKING_PALM,DOTON_EARTH_DRAGON,WATER_CLONE)
