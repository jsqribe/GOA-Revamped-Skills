var/no_bunshin_skills = list(BUNSHIN, KAGE_BUNSHIN, TAJUU_KAGE_BUNSHIN, HENGE, EXPLODING_KAGE_BUNSHIN,
                             ...
                             FALSE_DARKNESS, FOUR_PILLAR_BIND, CHAKRA_ENHANCEMENT,DOTON_EARTH_SHAKING_PALM, DOTON_PRISON_DOME, DOTON_EARTH_DRAGON,
                             FRONT_LOTUS, C4, C0, EXPLODING_BARRAGE, EXPLODING_OWL, SHUKAKU, NIBI, SANBI, YONBI, GOBI, ROKUBI, SHICHIBI,
